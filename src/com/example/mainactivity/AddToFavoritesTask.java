...
public class AddToFavoritesTask extends AsyncTask<Void, Void, Integer> {
	String favsUrl = "http://cci-webdev.uncc.edu/~mshehab/api-rest/favorites/addToFavorites.php";
	String postParam; //= "uid=b4e415e5240ab38ca488b5c6a643c17a";
	Activity activity;
	SharedPreferences sharedPrefs;
	String movieId;
	ImageButton favButton;
	
	public AddToFavoritesTask(Activity a, String id, ImageButton ib) {
